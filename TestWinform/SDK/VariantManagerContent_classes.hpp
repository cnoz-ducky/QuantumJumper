...
static_assert(sizeof(ALevelVariantSetsActor) == 0x000230, "Wrong size on ALevelVariantSetsActor");
static_assert(offsetof(ALevelVariantSetsActor, LevelVariantSets) == 0x000218, "Member 'ALevelVariantSetsActor::LevelVariantSets' has a wrong offset!");
...
static_assert(offsetof(UPropertyValue, Properties) == 0x000080, "Member 'UPropertyValue::Properties' has a wrong offset!");
static_assert(offsetof(UPropertyValue, PropertyIndices) == 0x000090, "Member 'UPropertyValue::PropertyIndices' has a wrong offset!");
static_assert(offsetof(UPropertyValue, CapturedPropSegments) == 0x0000A0, "Member 'UPropertyValue::CapturedPropSegments' has a wrong offset!");
static_assert(offsetof(UPropertyValue, FullDisplayString) == 0x0000B0, "Member 'UPropertyValue::FullDisplayString' has a wrong offset!");
static_assert(offsetof(UPropertyValue, PropertySetterName) == 0x0000C0, "Member 'UPropertyValue::PropertySetterName' has a wrong offset!");
static_assert(offsetof(UPropertyValue, PropertySetterParameterDefaults) == 0x0000C8, "Member 'UPropertyValue::PropertySetterParameterDefaults' has a wrong offset!");
static_assert(offsetof(UPropertyValue, bHasRecordedData) == 0x000118, "Member 'UPropertyValue::bHasRecordedData' has a wrong offset!");
static_assert(offsetof(UPropertyValue, LeafPropertyClass) == 0x000120, "Member 'UPropertyValue::LeafPropertyClass' has a wrong offset!");
static_assert(offsetof(UPropertyValue, ValueBytes) == 0x000128, "Member 'UPropertyValue::ValueBytes' has a wrong offset!");
static_assert(offsetof(UPropertyValue, PropCategory) == 0x000138, "Member 'UPropertyValue::PropCategory' has a wrong offset!");
...
static_assert(sizeof(ASwitchActor) == 0x000238, "Wrong size on ASwitchActor");
static_assert(offsetof(ASwitchActor, SceneComponent) == 0x000230, "Member 'ASwitchActor::SceneComponent' has a wrong offset!");
