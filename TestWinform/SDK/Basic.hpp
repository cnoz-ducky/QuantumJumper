...
namespace Offsets
{
	constexpr int32 GObjects          = 0x03F0AD70;
	constexpr int32 AppendString      = 0x00A25D90;
	constexpr int32 GNames            = 0x03EF3480;
	constexpr int32 GWorld            = 0x03FF4900;
	constexpr int32 ProcessEvent      = 0x00BD7110;
