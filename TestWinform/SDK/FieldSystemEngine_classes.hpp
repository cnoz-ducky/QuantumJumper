...
public:
	...
	TArray<TSoftObjectPtr<class AChaosSolverActor>> SupportedSolvers;                                // 0x03F0(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFieldSystemComponent) == 0x000420, "Wrong size on UFieldSystemComponent");
static_assert(offsetof(UFieldSystemComponent, FieldSystem) == 0x0003D8, "Member 'UFieldSystemComponent::FieldSystem' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, SupportedSolvers) == 0x0003F0, "Member 'UFieldSystemComponent::SupportedSolvers' has a wrong offset!");
