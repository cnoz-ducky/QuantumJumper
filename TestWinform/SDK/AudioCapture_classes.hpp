...
{
public:
	int32                                         JitterLatencyFrames;                               // 0x0620(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAudioCaptureComponent) == 0x0006D0, "Wrong size on UAudioCaptureComponent");
static_assert(offsetof(UAudioCaptureComponent, JitterLatencyFrames) == 0x000620, "Member 'UAudioCaptureComponent::JitterLatencyFrames' has a wrong offset!");
