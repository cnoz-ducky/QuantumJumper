...
// 0x0010 (0x0010 - 0x0000)
struct FAkPluginList final
{
public:
	TArray<class FString>                         PluginNames;                                       // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAkPluginList) == 0x000008, "Wrong alignment on FAkPluginList");
static_assert(sizeof(FAkPluginList) == 0x000010, "Wrong size on FAkPluginList");
static_assert(offsetof(FAkPluginList, PluginNames) == 0x000000, "Member 'FAkPluginList::PluginNames' has a wrong offset!");
