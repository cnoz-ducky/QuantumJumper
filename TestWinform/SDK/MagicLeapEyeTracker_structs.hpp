...
struct FMagicLeapFixationComfort final
{
public:
...
static_assert(alignof(FMagicLeapFixationComfort) == 0x000004, "Wrong alignment on FMagicLeapFixationComfort");
static_assert(sizeof(FMagicLeapFixationComfort) == 0x000008, "Wrong size on FMagicLeapFixationComfort");
static_assert(offsetof(FMagicLeapFixationComfort, FixationDepthIsUncomfortable) == 0x000000, "Member 'FMagicLeapFixationComfort::FixationDepthIsUncomfortable' has a wrong offset!");
static_assert(offsetof(FMagicLeapFixationComfort, FixationDepthViolationHasOccurred) == 0x000001, "Member 'FMagicLeapFixationComfort::FixationDepthViolationHasOccurred' has a wrong offset!");
static_assert(offsetof(FMagicLeapFixationComfort, RemainingTimeAtUncomfortableDepth) == 0x000004, "Member 'FMagicLeapFixationComfort::RemainingTimeAtUncomfortableDepth' has a wrong offset!");
