...
static_assert(sizeof(USteamNetDriver) == 0x000760, "Wrong size on USteamNetDriver");
...
public:
	...
	uint8                                         Pad_1A21[0x7];                                     // 0x1A21(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001A28, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001A20, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
