...
static_assert(sizeof(FMagicLeapPlaneResult) == 0x000050, "Wrong size on FMagicLeapPlaneResult");
...
static_assert(sizeof(FMagicLeapPlanesQuery) == 0x000050, "Wrong size on FMagicLeapPlanesQuery");
