...
// Enum ChromaSDKPlugin.EChromaDevice
// NumValues: 0x0007
enum class EChromaDevice : uint8
{
	ChromaLink                               = 0,
	Headset                                  = 1,
	Keyboard                                 = 2,
...
// ScriptStruct ChromaSDKPlugin.ChromaKeyColor
// 0x0028 (0x0028 - 0x0000)
struct FChromaKeyColor final
{
public:
	EChromaSDKKeyboardKey                         Key;                                               // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FChromaKeyColor) == 0x000008, "Wrong alignment on FChromaKeyColor");
static_assert(sizeof(FChromaKeyColor) == 0x000028, "Wrong size on FChromaKeyColor");
static_assert(offsetof(FChromaKeyColor, Key) == 0x000000, "Member 'FChromaKeyColor::Key' has a wrong offset!");
static_assert(offsetof(FChromaKeyColor, Color) == 0x000004, "Member 'FChromaKeyColor::Color' has a wrong offset!");
static_assert(offsetof(FChromaKeyColor, Group) == 0x000018, "Member 'FChromaKeyColor::Group' has a wrong offset!");
