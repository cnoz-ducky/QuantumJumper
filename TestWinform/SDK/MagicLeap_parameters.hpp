...
{
public:
	TSet<EMagicLeapHeadTrackingMapEvent>          MapEvents;                                         // 0x0000(0x0050)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// 0x0010 (0x0010 - 0x0000)
struct MeshTrackerComponent_ConnectBlockSelector final
{
public:
...
static_assert(alignof(MeshTrackerComponent_ConnectBlockSelector) == 0x000008, "Wrong alignment on MeshTrackerComponent_ConnectBlockSelector");
static_assert(sizeof(MeshTrackerComponent_ConnectBlockSelector) == 0x000010, "Wrong size on MeshTrackerComponent_ConnectBlockSelector");
static_assert(offsetof(MeshTrackerComponent_ConnectBlockSelector, Selector) == 0x000000, "Member 'MeshTrackerComponent_ConnectBlockSelector::Selector' has a wrong offset!");

// Function MagicLeap.MeshTrackerComponent.ConnectMRMesh
// 0x0008 (0x0008 - 0x0000)
struct MeshTrackerComponent_ConnectMRMesh final
{
public:
...
static_assert(alignof(MeshTrackerComponent_ConnectMRMesh) == 0x000008, "Wrong alignment on MeshTrackerComponent_ConnectMRMesh");
static_assert(sizeof(MeshTrackerComponent_ConnectMRMesh) == 0x000008, "Wrong size on MeshTrackerComponent_ConnectMRMesh");
static_assert(offsetof(MeshTrackerComponent_ConnectMRMesh, InMRMeshPtr) == 0x000000, "Member 'MeshTrackerComponent_ConnectMRMesh::InMRMeshPtr' has a wrong offset!");

// Function MagicLeap.MeshTrackerComponent.DisconnectMRMesh
// 0x0008 (0x0008 - 0x0000)
struct MeshTrackerComponent_DisconnectMRMesh final
{
public:
	class UMRMeshComponent*                       InMRMeshPtr;                                       // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MeshTrackerComponent_DisconnectMRMesh) == 0x000008, "Wrong alignment on MeshTrackerComponent_DisconnectMRMesh");
static_assert(sizeof(MeshTrackerComponent_DisconnectMRMesh) == 0x000008, "Wrong size on MeshTrackerComponent_DisconnectMRMesh");
static_assert(offsetof(MeshTrackerComponent_DisconnectMRMesh, InMRMeshPtr) == 0x000000, "Member 'MeshTrackerComponent_DisconnectMRMesh::InMRMeshPtr' has a wrong offset!");

// Function MagicLeap.MeshTrackerComponent.GetNumQueuedBlockUpdates
// 0x0004 (0x0004 - 0x0000)
struct MeshTrackerComponent_GetNumQueuedBlockUpdates final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MeshTrackerComponent_GetNumQueuedBlockUpdates) == 0x000004, "Wrong alignment on MeshTrackerComponent_GetNumQueuedBlockUpdates");
static_assert(sizeof(MeshTrackerComponent_GetNumQueuedBlockUpdates) == 0x000004, "Wrong size on MeshTrackerComponent_GetNumQueuedBlockUpdates");
static_assert(offsetof(MeshTrackerComponent_GetNumQueuedBlockUpdates, ReturnValue) == 0x000000, "Member 'MeshTrackerComponent_GetNumQueuedBlockUpdates::ReturnValue' has a wrong offset!");

// Function MagicLeap.MeshTrackerComponent.SelectMeshBlocks
// 0x0028 (0x0028 - 0x0000)
struct MeshTrackerComponent_SelectMeshBlocks final
{
public:
	struct FMagicLeapTrackingMeshInfo             NewMeshInfo;                                       // 0x0000(0x0018)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	TArray<struct FMagicLeapMeshBlockRequest>     RequestedMesh;                                     // 0x0018(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(MeshTrackerComponent_SelectMeshBlocks) == 0x000008, "Wrong alignment on MeshTrackerComponent_SelectMeshBlocks");
static_assert(sizeof(MeshTrackerComponent_SelectMeshBlocks) == 0x000028, "Wrong size on MeshTrackerComponent_SelectMeshBlocks");
static_assert(offsetof(MeshTrackerComponent_SelectMeshBlocks, NewMeshInfo) == 0x000000, "Member 'MeshTrackerComponent_SelectMeshBlocks::NewMeshInfo' has a wrong offset!");
static_assert(offsetof(MeshTrackerComponent_SelectMeshBlocks, RequestedMesh) == 0x000018, "Member 'MeshTrackerComponent_SelectMeshBlocks::RequestedMesh' has a wrong offset!");
