...
public:
	...
	ERTPCValueType                                InputValueType;                                    // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ERTPCValueType                                OutputValueType;                                   // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PlayingID;                                         // 0x001C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(AkComponent_GetRTPCValue, InputValueType) == 0x000010, "Member 'AkComponent_GetRTPCValue::InputValueType' has a wrong offset!");
static_assert(offsetof(AkComponent_GetRTPCValue, Value) == 0x000014, "Member 'AkComponent_GetRTPCValue::Value' has a wrong offset!");
static_assert(offsetof(AkComponent_GetRTPCValue, OutputValueType) == 0x000018, "Member 'AkComponent_GetRTPCValue::OutputValueType' has a wrong offset!");
static_assert(offsetof(AkComponent_GetRTPCValue, PlayingID) == 0x00001C, "Member 'AkComponent_GetRTPCValue::PlayingID' has a wrong offset!");
